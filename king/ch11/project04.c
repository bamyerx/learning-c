/*
 * Project 4 from Chapter 11 of King: Modify the poker.c program of Section 10.5
 * by moving all external variables into main and modifying functions so that 
 * they communicate by passing arguments. The analyze_hand function needs to
 * change the straight, flush, four, three, and pairs variables, so it will have
 * to be passed pointers to those variables.
 */
...
void analyze_hand(int [], int [], bool *, bool *, bool *, bool *, int *);
...
int main(void)
{
    int num_in_rank[NUM_RANKS], num_in_suit[NUM_SUITS], pairs;
 ...
 *               of pairs; stores the result into straight, flush, four, three, 
 *               and pairs.
 */
