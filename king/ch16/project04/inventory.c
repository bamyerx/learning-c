/*
 * Project 4 from Chapter 16 of King: Modify the inventory.c program of Section
 * 16.3 by adding a price member to the part structure. The insert function
 * should ask the user for the price of a new item. The search and print
 * functions should display the price. Add a new command that allows the user
...
/*
 * reprice: Prompts the user to enter a part number. Prints an error message if
 *          the part doesn't exist; otherwise, prompts the user to enter the new
