/* 
 * Project 5 from Chapter 10 of King: Modify the poker.c program of Section 10.5
 * by allowing "ace-low" straights (ace, two, three four, five).
 */
...
void analyze_hand(void)
{
   ...
   if (num_consec == NUM_CARDS - 1 && num_in_rank[0] && num_in_rank[12]) {
      straight = true;
      return;
   }
