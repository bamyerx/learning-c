/* 
 * Project 4 from Chapter 10 of King: Modify the poker.c program of Section 10.5
 * by having it recognize an additional category, "royal flush" (ace, king,
 * queen, jack, ten of the same suit). A royal flush ranks higher than all other
 * hands.
 */
...
{
   if (num_in_rank[12] &&
       straight && flush) printf("Royal flush");
   else if (straight && 
