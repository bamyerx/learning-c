/*
 * Project 2 from Chapter 17 of King: Modify the inventory.c program of Section
 * 16.3 so that the p (print) command calls qsort to sort the inventory array
...
/*
 * compare_parts: Comparison function for parts by part number.
 */
