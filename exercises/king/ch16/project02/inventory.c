/*
 * Project 2 from Chapter 16 of King: Modify the inventory.c program of Section
 * 16.3 so that the p (print) operation displays the parts sorted by part
 * number.
 */
 ...
 *        ascending order by part number.
 */
void print(void)
{
	int i;
