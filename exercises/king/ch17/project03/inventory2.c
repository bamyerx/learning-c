/*
 * Project 3 from Chapter 17 of King: Modify the inventory2.c program of Section
 * 17.5 by adding an e (erase) command that allows the user to remove a part
 * from the database.
 */
...
/*
 * erase: Prompts the user to enter a part number and removes the part from the
 *        database. If the part doesn't exist, the command has no effect.
 */
void erase(void)
{
	int number;
